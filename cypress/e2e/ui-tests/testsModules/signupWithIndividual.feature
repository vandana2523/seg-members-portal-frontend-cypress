Feature: Akoni Individual Sign-Up  Journey
    ...
    #     Then The user should be get the validation error message when terms and condition not selected "Must accept terms and conditions to sign up"
    ...
    Scenario: Add user with a duplicate email ID
        ...
        Then I should see a validation error message "Already registered."
